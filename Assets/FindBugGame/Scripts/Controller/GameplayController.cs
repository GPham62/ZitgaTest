...
namespace Controller
{
    public class GameplayController : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            m_pathFinder.Init(startPos, endPos);
            Instantiate(m_playerPrefab, m_mazeMaker.GetMazePositionTransform(startPos).position + m_playerPrefab.transform.position, m_playerPrefab.transform.rotation);
